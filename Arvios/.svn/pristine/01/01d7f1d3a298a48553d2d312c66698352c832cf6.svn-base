...
class ezTweet {
  ...
  public function __construct($aTweetApi) {
    
    $this->consumer_key     = $aTweetApi['consumer_key'];
    $this->consumer_secret  = $aTweetApi['consumer_secret'];
    $this->user_token       = $aTweetApi['user_token'];
    $this->user_secret      = $aTweetApi['user_secret'];
