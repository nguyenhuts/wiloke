<div id="table-fa" class="wrap-table-list" style="display: none">
    <ul id="fa-table-list" class="pi-tb-fa">      
      <div class="pi-collection">
            <h3><?php _e('Web Application Icons', 'wiloke');?></h3>
      ...
      <div class="pi-collection">
            <h3><?php _e('Form Control Icons', 'wiloke');?></h3>
            <ul class="clearfix">
                  <li><i class="fa fa-check-square"></i></li>
      ...
      <div class="pi-collection">
            <h3><?php _e('Text Editor Icons', 'wiloke');?></h3>
            <ul class="clearfix">
      ...
      <div class="pi-collection">
            <h3><?php _e('Directional Icons', 'wiloke');?></h3>
            <ul class="clearfix">
      ...
      <div class="pi-collection">
            <h3><?php _e('Video Player Icons', 'wiloke');?></h3>
            <ul class="clearfix">
                  <li><i class="fa fa-arrows-alt"></i></li>
      ...
      <div class="pi-collection pi-socials">
            <h3><?php _e('Brand Icons', 'wiloke');?></h3>
            <ul class="clearfix">
